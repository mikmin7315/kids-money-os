  ...
  return (
    <main className="monari-auth-shell">
      <section className="monari-card w-full p-6 text-center">
        <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--monari-minus-bg)] text-[var(--monari-minus)]">
        ...
        {error.digest && (
          <p className="mt-2 rounded-[10px] bg-[var(--monari-surface-soft)] px-3 py-1.5 text-[11px] font-mono text-[var(--monari-ink-muted)]">
            오류 코드: {error.digest}
          </p>
        )}
