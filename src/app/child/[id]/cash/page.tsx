  ...
  return (
    ...
    <main className="px-4 pb-36 pt-8">
      ...
      <div className="mb-5 rounded-[24px] bg-[var(--status-pending-solid)] p-4">
        <p style={{ fontSize: 13, fontWeight: 700, color: "var(--status-pending-solid-text)" }}>💡 이렇게 쓸 때 기록해요</p>
        <ul className="mt-2 space-y-1" style={{ fontSize: 13, color: "var(--monari-pending)" }}>
